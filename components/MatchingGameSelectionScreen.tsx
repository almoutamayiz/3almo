...
const MatchingGameSelectionScreen: React.FC<MatchingGameSelectionScreenProps> = ({ onStartGame, onBack }) => {
    ...
    return (
        ...
        <div className="h-screen w-full bg-[#2d1b15] text-[#d7ccc8] flex flex-col font-serif relative overflow-y-auto">
            ...
            <header className="p-4 flex items-center justify-between z-10 bg-[#3e2723] border-b-4 border-[#271c19] shadow-xl shrink-0">
            ...
            <main className="flex-1 p-6 z-10 max-w-2xl mx-auto w-full space-y-8 pb-20">
