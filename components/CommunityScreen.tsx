...
const CommunityScreen: React.FC<{ user: User }> = ({ user }) => {
    ...
    useEffect(() => {
        if (selectedSubject) {
            ...
            // تصحيح الاشتراك: إضافة schema: 'public' واستخدام cast للنوع لتجاوز خطأ TypeScript
    ...
    if (selectedSubject) {
        return (
            <div className="fixed top-0 left-0 right-0 bottom-14 z-[60] bg-black flex flex-col animate-fadeIn overflow-hidden">
                ...
                <div className="bg-neutral-900/95 backdrop-blur-xl border-t border-white/10 p-3 shrink-0">
